...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            "URL prefix containing scene_000.png, scene_001.png, ... . "
            "Use the site-root path for deployment or a relative path for local testing."
        ),
    )
    ...
    fig = make_plotly_figure(
        ...
        image_indices=image_indices,
        thumbnail_url_prefix=args.thumbnail_url_prefix,
    )
